            ...
            <div>
                <div className="container center-items" style={{height:"80vh"}}>
                    <div className="login-form col-lg-6 col-12  p-1">
                        ...
                        Добро пожаловать в онлайн дневник!<br/> Если вы впервые в нашем сайте, то вам необходмо зарегистрироваться.
                        </div>
                        ...
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div className="text-center"><Link to="./emailregister" style={{color:'blue'}} >Регистрация c помощю Электронной Почты</Link> </div>
