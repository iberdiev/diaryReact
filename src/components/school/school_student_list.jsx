    ...
    render() {
        return(
            <tr>
                ...
                <td className="p-3"><Link to={{pathname: '/school/student_profile/', state: { studentName: this.props.name, pk: this.props.pk, cohortID: this.props.cohortID}}}>{this.props.name}</Link></td>
            </tr>
        )
    }
}
            ...
            <div className="d-flex justify-content-center mt-2">
                <div className="col-lg-6 col-12  p-1 ">
                    ...
                    <table id="table_id" className="table table-striped table-bordered display" style={{width:'100%'}}>
                        ...
                        <tbody>
                            {data.map((student, i) => (
                                <OneStudent key={i+1} number={i+1} name={student.studentName} pk={student.pk} cohortID={this.props.location.state.cohortID} />
                            ))}
                        </tbody>
                    </table>
                </div>
